  ...
  <body>
  	...
  	<div class="container">
        ...
        <div class="row add-margin">
          <div class="col-md-12">
            <h3 style="color:white"> Edit News Category</h3>
          </div>
        </div>
        ...
        <div class="row pad-left">
          <div class="col-md-12">
            ...
            <div><h4 style="color:yellow;"> <?php if(isset($recipe)) echo "Do you want to edit " . $recipe->news_title . " category ?"; ?> </h4></div>
              ...
              <tbody>
                <tr>
                  <td>News title:</td>
                  <td><input type="text" name="news_title" class="form-control" required id="inputName" placeholder="<?php if(isset($recipe)) echo $recipe->news_title; ?>"></td>
                </tr>
                <tr>
              ...
              <button type="submit" class="btn btn-default button-position color-white">Edit News</button> </div>
              </form>
            </div>
          </div>
