  ...
  <body>
  	...
  	<div class="container">
        ...
        <div class="row add-margin">
          <div class="col-md-12">
            <h3 style="color:white"> Edit News Item </h3>
          </div>
        </div>
        ...
        <div class="row pad-left">
          <div class="col-md-12">
            ...
            <div><h4 style="color:yellow;"> <?php if(isset($singleNews)) echo "Do you want to edit " . $singleNews->news_title . " ?"; ?> </h4></div>
              ...
              <tbody>
                <tr>
                  <td>News title:</td>
                  <td><input type="text" name="news_title" class="form-control mform-field" required id="inputName" value="<?php if(isset($singleNews)) echo $singleNews->news_title; ?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>News Content</td>
									<td><textarea class="mform-field" rows="10" cols="80" name="news_content" required ><?php if(isset($singleNews)) echo $singleNews->news_content; ?> </textarea></td>
								</tr>
                  ...
                  <td>
                    ...
                    <select name="news_category_id" class="mform-field">
                      ...
                      if(isset($news)){
                          foreach($news as $new){ ?>
                            <option value="<?php if(isset($new->id)) echo $new->id; ?>"> <?php if(isset($new->news_title)) echo $new->news_title; ?> </option>
                      <?php  } }
                      ?>
