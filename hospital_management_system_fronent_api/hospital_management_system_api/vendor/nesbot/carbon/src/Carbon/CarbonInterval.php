 ...
 *
 * @property int $books Total books of the current interval.
 ...
 *
 * @method static CarbonInterval books($books = 1) Create instance specifying a number of books.
 * @method static CarbonInterval book($books = 1) Alias for books()
 ...
 * @method CarbonInterval books() books($books = 1) Set the books portion of the current interval.
 * @method CarbonInterval book() book($books = 1) Alias for books().
...
class CarbonInterval extends DateInterval
{
     ...
     * @param int $seconds
     */
    public function __construct($books = 1, $months = null, $weeks = null, $days = null, $hours = null, $minutes = null, $seconds = null)
    {
        $spec = static::PERIOD_PREFIX;

        $spec .= $books > 0 ? $books.static::PERIOD_YEARS : '';
     ...
     * @return static
     */
    public static function create($books = 1, $months = null, $weeks = null, $days = null, $hours = null, $minutes = null, $seconds = null)
    {
        return new static($books, $months, $weeks, $days, $hours, $minutes, $seconds);
    }

    /**
     * Provide static helpers to create instances.  Allows CarbonInterval::books(3).
     *
    ...
    /**
     * Allow fluent calls on the setters... CarbonInterval::books(3)->months(5)->day().
     *
     * Note: This is done using the magic method to allow static and instance methods to
     *       have the same names.
     *
    ...
    public function add(DateInterval $interval)
    {
        ...
        if (static::wasCreatedFromDiff($interval)) {
            ...
            $this->books = $this->books + $interval->y * $sign;
