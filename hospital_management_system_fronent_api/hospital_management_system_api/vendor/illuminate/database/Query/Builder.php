...
class Builder
{
    ...
    /**
     * Add a "where book" statement to the query.
     *
     * @param  string  $column
     * @param  string   $operator
     * @param  int   $value
     ...
     * @return \Illuminate\Database\Query\Builder|static
     */
    public function whereBook($column, $operator, $value, $boolean = 'and')
    {
        return $this->addDateBasedWhere('Book', $column, $operator, $value, $boolean);
    }

    /**
     * Add a date based (book, month, day) statement to the query.
     *
     * @param  string  $type
     * @param  string  $column
     * @param  string  $operator
